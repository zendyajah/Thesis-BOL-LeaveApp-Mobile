...
class ApprovalListPage extends StatelessWidget {
  ...
  final _apiUrl = "http://192.168.1.2:5031/api/c/documents";
  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => DocumentsubmitBloc(_apiUrl)..add(GetDocumentEvent()),
      child: Scaffold(
          appBar: AppBar(title: const Text("Approval List")),
